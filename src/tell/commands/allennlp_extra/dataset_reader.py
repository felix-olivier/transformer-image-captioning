...
# from src.tell.data.fields import ImageField


@DatasetReader.register('nos_reader')
class NOSReader(DatasetReader):
    def __init__(self,
                 tokenizer: Tokenizer,
    ...
    def _read(self, split: str):
        ...
        print('DATASET READER', flush=True)
        ...
        ids = os.listdir('/data/images/480_sample')
        ids = [i[:-4] for i in ids if i.endswith('.jpg')]
        df = pd.read_csv(
            './data/480x270_v5cleaned.csv',
