...
# Register custom allennlp modules
import src.tell.training
import src.tell.training.optimizers
import src.tell.training.callback_apex_trainer
import src.tell.commands.allennlp_extra.dataset_reader
import src.tell.commands.allennlp_extra.word_splitter
import src.tell.commands.allennlp_extra.roberta_indexer
import src.tell.commands.allennlp_extra.vocabulary
import src.tell.commands.allennlp_extra.transformed_flattened
