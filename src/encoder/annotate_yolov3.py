...
from src.tell.models.resnet import resnet152
from src.tell.utils.logger import setup_logger
from src.tell.yolov3.models import Darknet, attempt_download, load_darknet_weights
from src.tell.yolov3.utils import torch_utils
from src.tell.yolov3.utils.datasets import LoadImages
from src.tell.yolov3.utils.utils import (load_classes, non_max_suppression,
...
def detect(opt):
    ...
    with open('/data/images/480_sample_obj_feats.pkl', 'wb') as handle:
